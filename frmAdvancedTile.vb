...
Friend Class frmAdvancedTile
	...
	'UPGRADE_WARNING: Event cboTileBox.SelectedIndexChanged may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub cboTileBox_SelectedIndexChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboTileBox.SelectedIndexChanged
		Number = cboTileBox.SelectedIndex + 1
		cboTileListSet.SelectedIndex = cboTileBox.SelectedIndex
		
		picCurrentTile.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & "\blank.bmp")
	...
	Private Sub cmdBasicTraining_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdBasicTraining.Click
		Me.Close()
		frmTileEdit.Show()
	End Sub
	...
	Private Sub CmdInsert_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdInsert.Click
		...
		X = picOpenedTile.ClientRectangle.Width
		Y = picOpenedTile.ClientRectangle.Height
		For i = 0 To Y - 1
		...
		Next 
		ReallyRitePallette()
		LocationLocationLocation = My.Application.Info.DirectoryPath & "\temp2.tmp"
		WriteTile2()
		Insert_Tile()
		BlockInput(False)
	...
	Private Sub cmdNewTile_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdNewTile.Click
		picOpenedTile.Image = System.Drawing.Image.FromFile(My.Application.Info.DirectoryPath & "\blank.bmp")
		DumpTIS()
		counter = counter + 1
		cboTileBox.Items.Insert(counter - 1, "Tile # " & counter - 1)
		cboTileListSet.Items.Insert(counter - 1, "Tile # " & counter - 1)
		cboTileListSet.SelectedIndex = counter - 1
		CmdInsert_Click(CmdInsert, New System.EventArgs())
	End Sub
	
	Private Sub cmdOpenBitmap_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdOpenBitmap.Click
		Dim NumberTizemp As Integer
		Dim StrTizemp As String
		StrTizemp = cboTileListSet.Text
		
		NumberTizemp = cboTileBox.SelectedIndex
		...
		With cdgDialog
			...
			If Err.Number = 0 Then
				If .FileName <> vbNullString Then
					picOpenedTile.Image = System.Drawing.Image.FromFile(cdgDialogOpen.FileName)
				End If
			End If
		End With
	...
	Private Sub cmdOpenTIS_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdOpenTIS.Click
		...
		With cdgDialog
			...
			If Err.Number = 0 Then
				If .FileName <> vbNullString Then
					TISLocation = cdgDialogOpen.FileName
				End If
			End If
		End With
		TIS_Open()
	...
	Public Sub TIS_Open()
		...
		Dim this_will_loop As Integer
		ReDim TIS(TISsize)
		
		FileOpen(9, TISLocation, OpenMode.Binary, OpenAccess.Read)
		For this_will_loop = 1 To TISsize
			...
			FileGet(9, TIS(this_will_loop), this_will_loop)
		Next 
		FileClose(9)
		Dim Tempcount As Integer
		Dim Looper As Integer
		
		Tempcount = cboTileBox.Items.Count
		
		For Looper = 0 To Tempcount - 1
			cboTileBox.Items.RemoveAt((Looper))
		Next 
		For Looper = 0 To Tempcount - 1
			cboTileListSet.Items.RemoveAt((Looper))
		Next 
	...
	Private Sub Header()
		If TIS(1) = 84 And TIS(2) = 73 And TIS(3) = 83 Then
			...
			blnHeader = True
		Else
			chkHeader.CheckState = System.Windows.Forms.CheckState.Unchecked
			blnHeader = False
		End If
	...
	Public Sub TileSet()
		...
		If blnHeader = True Then
			Size_Renamed = TISsize - 24
		Else
			Size_Renamed = TISsize
		End If
		
		TileCount = Size_Renamed / 5120
		
		For counter = 0 To TileCount - 1
			cboTileBox.Items.Insert(counter, "Tile # " & counter)
		Next 
		
		For counter = 0 To TileCount - 1
			cboTileListSet.Items.Insert(counter, "Tile # " & counter)
		Next 
	...
	Public Sub Tile_Open()
		...
		For Looper = 1024 To 5119
			If File(Looper) = 0 Then
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB001)
			ElseIf File(Looper) = 1 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB002)
			ElseIf File(Looper) = 2 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB003)
			ElseIf File(Looper) = 3 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB004)
			ElseIf File(Looper) = 4 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB005)
			ElseIf File(Looper) = 5 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB006)
			ElseIf File(Looper) = 6 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB007)
			ElseIf File(Looper) = 7 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB008)
			ElseIf File(Looper) = 8 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB009)
			ElseIf File(Looper) = 9 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB010)
			ElseIf File(Looper) = 10 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB011)
			ElseIf File(Looper) = 11 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB012)
			ElseIf File(Looper) = 12 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB013)
			ElseIf File(Looper) = 13 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB014)
			ElseIf File(Looper) = 14 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB015)
			ElseIf File(Looper) = 15 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB016)
			ElseIf File(Looper) = 16 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB017)
			ElseIf File(Looper) = 17 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB018)
			ElseIf File(Looper) = 18 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB019)
			ElseIf File(Looper) = 19 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB020)
			ElseIf File(Looper) = 20 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB021)
			ElseIf File(Looper) = 21 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB022)
			ElseIf File(Looper) = 22 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB023)
			ElseIf File(Looper) = 23 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB024)
			ElseIf File(Looper) = 24 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB025)
			ElseIf File(Looper) = 25 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB026)
			ElseIf File(Looper) = 26 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB027)
			ElseIf File(Looper) = 27 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB028)
			ElseIf File(Looper) = 28 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB029)
			ElseIf File(Looper) = 29 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB030)
			ElseIf File(Looper) = 30 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB031)
			ElseIf File(Looper) = 31 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB032)
			ElseIf File(Looper) = 32 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB033)
			ElseIf File(Looper) = 33 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB034)
			ElseIf File(Looper) = 34 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB035)
			ElseIf File(Looper) = 35 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB036)
			ElseIf File(Looper) = 36 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB037)
			ElseIf File(Looper) = 37 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB038)
			ElseIf File(Looper) = 38 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB039)
			ElseIf File(Looper) = 39 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB040)
			ElseIf File(Looper) = 40 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB041)
			ElseIf File(Looper) = 41 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB042)
			ElseIf File(Looper) = 42 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB043)
			ElseIf File(Looper) = 43 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB044)
			ElseIf File(Looper) = 44 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB045)
			ElseIf File(Looper) = 45 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB046)
			ElseIf File(Looper) = 46 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB047)
			ElseIf File(Looper) = 47 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB048)
			ElseIf File(Looper) = 48 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB049)
			ElseIf File(Looper) = 49 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB050)
			ElseIf File(Looper) = 50 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB051)
			ElseIf File(Looper) = 51 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB052)
			ElseIf File(Looper) = 52 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB053)
			ElseIf File(Looper) = 53 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB054)
			ElseIf File(Looper) = 54 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB055)
			ElseIf File(Looper) = 55 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB056)
			ElseIf File(Looper) = 56 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB057)
			ElseIf File(Looper) = 57 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB058)
			ElseIf File(Looper) = 58 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB059)
			ElseIf File(Looper) = 59 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB060)
			ElseIf File(Looper) = 60 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB061)
			ElseIf File(Looper) = 61 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB062)
			ElseIf File(Looper) = 62 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB063)
			ElseIf File(Looper) = 63 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB064)
			ElseIf File(Looper) = 64 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB065)
			ElseIf File(Looper) = 65 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB066)
			ElseIf File(Looper) = 66 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB067)
			ElseIf File(Looper) = 67 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB068)
			ElseIf File(Looper) = 68 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB069)
			ElseIf File(Looper) = 69 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB070)
			ElseIf File(Looper) = 70 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB071)
			ElseIf File(Looper) = 71 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB072)
			ElseIf File(Looper) = 72 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB073)
			ElseIf File(Looper) = 73 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB074)
			ElseIf File(Looper) = 74 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB075)
			ElseIf File(Looper) = 75 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB076)
			ElseIf File(Looper) = 76 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB077)
			ElseIf File(Looper) = 77 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB078)
			ElseIf File(Looper) = 78 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB079)
			ElseIf File(Looper) = 79 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB080)
			ElseIf File(Looper) = 80 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB081)
			ElseIf File(Looper) = 81 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB082)
			ElseIf File(Looper) = 82 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB083)
			ElseIf File(Looper) = 83 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB084)
			ElseIf File(Looper) = 84 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB085)
			ElseIf File(Looper) = 85 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB086)
			ElseIf File(Looper) = 86 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB087)
			ElseIf File(Looper) = 87 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB088)
			ElseIf File(Looper) = 88 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB089)
			ElseIf File(Looper) = 89 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB090)
			ElseIf File(Looper) = 90 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB091)
			ElseIf File(Looper) = 91 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB092)
			ElseIf File(Looper) = 92 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB093)
			ElseIf File(Looper) = 93 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB094)
			ElseIf File(Looper) = 94 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB095)
			ElseIf File(Looper) = 95 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB096)
			ElseIf File(Looper) = 96 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB097)
			ElseIf File(Looper) = 97 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB098)
			ElseIf File(Looper) = 98 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB099)
			ElseIf File(Looper) = 99 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB100)
			ElseIf File(Looper) = 100 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB101)
			ElseIf File(Looper) = 101 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB102)
			ElseIf File(Looper) = 102 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB103)
			ElseIf File(Looper) = 103 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB104)
			ElseIf File(Looper) = 104 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB105)
			ElseIf File(Looper) = 105 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB106)
			ElseIf File(Looper) = 106 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB107)
			ElseIf File(Looper) = 107 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB108)
			ElseIf File(Looper) = 108 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB109)
			ElseIf File(Looper) = 109 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB110)
			ElseIf File(Looper) = 110 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB111)
			ElseIf File(Looper) = 111 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB112)
			ElseIf File(Looper) = 112 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB113)
			ElseIf File(Looper) = 113 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB114)
			ElseIf File(Looper) = 114 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB115)
			ElseIf File(Looper) = 115 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB116)
			ElseIf File(Looper) = 116 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB117)
			ElseIf File(Looper) = 117 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB118)
			ElseIf File(Looper) = 118 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB119)
			ElseIf File(Looper) = 119 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB120)
			ElseIf File(Looper) = 120 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB121)
			ElseIf File(Looper) = 121 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB122)
			ElseIf File(Looper) = 122 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB123)
			ElseIf File(Looper) = 123 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB124)
			ElseIf File(Looper) = 124 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB125)
			ElseIf File(Looper) = 125 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB126)
			ElseIf File(Looper) = 126 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB127)
			ElseIf File(Looper) = 127 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB128)
			ElseIf File(Looper) = 128 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB129)
			ElseIf File(Looper) = 129 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB130)
			ElseIf File(Looper) = 130 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB131)
			ElseIf File(Looper) = 131 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB132)
			ElseIf File(Looper) = 132 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB133)
			ElseIf File(Looper) = 133 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB134)
			ElseIf File(Looper) = 134 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB135)
			ElseIf File(Looper) = 135 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB136)
			ElseIf File(Looper) = 136 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB137)
			ElseIf File(Looper) = 137 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB138)
			ElseIf File(Looper) = 138 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB139)
			ElseIf File(Looper) = 139 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB140)
			ElseIf File(Looper) = 140 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB141)
			ElseIf File(Looper) = 141 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB142)
			ElseIf File(Looper) = 142 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB143)
			ElseIf File(Looper) = 143 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB144)
			ElseIf File(Looper) = 144 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB145)
			ElseIf File(Looper) = 145 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB146)
			ElseIf File(Looper) = 146 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB147)
			ElseIf File(Looper) = 147 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB148)
			ElseIf File(Looper) = 148 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB149)
			ElseIf File(Looper) = 149 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB150)
			ElseIf File(Looper) = 150 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB151)
			ElseIf File(Looper) = 151 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB152)
			ElseIf File(Looper) = 152 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB153)
			ElseIf File(Looper) = 153 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB154)
			ElseIf File(Looper) = 154 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB155)
			ElseIf File(Looper) = 155 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB156)
			ElseIf File(Looper) = 156 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB157)
			ElseIf File(Looper) = 157 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB158)
			ElseIf File(Looper) = 158 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB159)
			ElseIf File(Looper) = 159 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB160)
			ElseIf File(Looper) = 160 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB161)
			ElseIf File(Looper) = 161 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB162)
			ElseIf File(Looper) = 162 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB163)
			ElseIf File(Looper) = 163 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB164)
			ElseIf File(Looper) = 164 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB165)
			ElseIf File(Looper) = 165 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB166)
			ElseIf File(Looper) = 166 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB167)
			ElseIf File(Looper) = 167 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB168)
			ElseIf File(Looper) = 168 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB169)
			ElseIf File(Looper) = 169 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB170)
			ElseIf File(Looper) = 170 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB171)
			ElseIf File(Looper) = 171 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB172)
			ElseIf File(Looper) = 172 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB173)
			ElseIf File(Looper) = 173 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB174)
			ElseIf File(Looper) = 174 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB175)
			ElseIf File(Looper) = 175 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB176)
			ElseIf File(Looper) = 176 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB177)
			ElseIf File(Looper) = 177 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB178)
			ElseIf File(Looper) = 178 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB179)
			ElseIf File(Looper) = 179 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB180)
			ElseIf File(Looper) = 180 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB181)
			ElseIf File(Looper) = 181 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB182)
			ElseIf File(Looper) = 182 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB183)
			ElseIf File(Looper) = 183 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB184)
			ElseIf File(Looper) = 184 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB185)
			ElseIf File(Looper) = 185 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB186)
			ElseIf File(Looper) = 186 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB187)
			ElseIf File(Looper) = 187 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB188)
			ElseIf File(Looper) = 188 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB189)
			ElseIf File(Looper) = 189 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB190)
			ElseIf File(Looper) = 190 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB191)
			ElseIf File(Looper) = 191 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB192)
			ElseIf File(Looper) = 192 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB193)
			ElseIf File(Looper) = 193 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB194)
			ElseIf File(Looper) = 194 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB195)
			ElseIf File(Looper) = 195 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB196)
			ElseIf File(Looper) = 196 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB197)
			ElseIf File(Looper) = 197 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB198)
			ElseIf File(Looper) = 198 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB199)
			ElseIf File(Looper) = 199 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB200)
			ElseIf File(Looper) = 200 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB201)
			ElseIf File(Looper) = 201 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB202)
			ElseIf File(Looper) = 202 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB203)
			ElseIf File(Looper) = 203 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB204)
			ElseIf File(Looper) = 204 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB205)
			ElseIf File(Looper) = 205 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB206)
			ElseIf File(Looper) = 206 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB207)
			ElseIf File(Looper) = 207 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB208)
			ElseIf File(Looper) = 208 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB209)
			ElseIf File(Looper) = 209 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB210)
			ElseIf File(Looper) = 210 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB211)
			ElseIf File(Looper) = 211 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB212)
			ElseIf File(Looper) = 212 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB213)
			ElseIf File(Looper) = 213 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB214)
			ElseIf File(Looper) = 214 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB215)
			ElseIf File(Looper) = 215 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB216)
			ElseIf File(Looper) = 216 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB217)
			ElseIf File(Looper) = 217 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB218)
			ElseIf File(Looper) = 218 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB219)
			ElseIf File(Looper) = 219 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB220)
			ElseIf File(Looper) = 220 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB221)
			ElseIf File(Looper) = 221 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB222)
			ElseIf File(Looper) = 222 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB223)
			ElseIf File(Looper) = 223 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB224)
			ElseIf File(Looper) = 224 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB225)
			ElseIf File(Looper) = 225 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB226)
			ElseIf File(Looper) = 226 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB227)
			ElseIf File(Looper) = 227 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB228)
			ElseIf File(Looper) = 228 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB229)
			ElseIf File(Looper) = 229 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB230)
			ElseIf File(Looper) = 230 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB231)
			ElseIf File(Looper) = 231 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB232)
			ElseIf File(Looper) = 232 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB233)
			ElseIf File(Looper) = 233 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB234)
			ElseIf File(Looper) = 234 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB235)
			ElseIf File(Looper) = 235 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB236)
			ElseIf File(Looper) = 236 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB237)
			ElseIf File(Looper) = 237 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB238)
			ElseIf File(Looper) = 238 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB239)
			ElseIf File(Looper) = 239 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB240)
			ElseIf File(Looper) = 240 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB241)
			ElseIf File(Looper) = 241 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB242)
			ElseIf File(Looper) = 242 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB243)
			ElseIf File(Looper) = 243 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB244)
			ElseIf File(Looper) = 244 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB245)
			ElseIf File(Looper) = 245 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB246)
			ElseIf File(Looper) = 246 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB247)
			ElseIf File(Looper) = 247 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB248)
			ElseIf File(Looper) = 248 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB249)
			ElseIf File(Looper) = 249 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB250)
			ElseIf File(Looper) = 250 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB251)
			ElseIf File(Looper) = 251 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB252)
			ElseIf File(Looper) = 252 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB253)
			ElseIf File(Looper) = 253 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB254)
			ElseIf File(Looper) = 254 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB255)
			ElseIf File(Looper) = 255 Then 
				'UPGRADE_ISSUE: PictureBox property picCurrentTile.hDC was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				SetPixel(picCurrentTile.hDC, j, i, RGB256)
			End If
			j = j + 1
	...
	Private Sub cmdSaveBitmap_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdSaveBitmap.Click
		Dim temptilenumber As Integer
		On Error Resume Next
		'UPGRADE_WARNING: CommonDialog variable was not upgraded Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="671167DC-EA81-475D-B690-7A40C7BF4A23"'
		With cdgDialog
			'UPGRADE_WARNING: The CommonDialog CancelError property is not supported in Visual Basic .NET. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="8B377936-3DF7-4745-AA26-DD00FA5B9BE1"'
			...
			'UPGRADE_WARNING: Filter has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			.Filter = "Bitmap (*.bmp)"
			temptilenumber = cboTileBox.SelectedIndex
		...
		picCurrentTile.Image.Save(cdgDialogOpen.FileName)
		BlockInput(False)
		
		MsgBox("Done Saving Bitmap")
	End Sub
	
	Private Sub cmdSaveTile_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdSaveTile.Click
		BlockInput(True)
		
		X = picCurrentTile.ClientRectangle.Width
		Y = picCurrentTile.ClientRectangle.Height
		For i = 0 To Y - 1
			System.Windows.Forms.Application.DoEvents()
			For j = 0 To X - 1
				System.Windows.Forms.Application.DoEvents()
	...
	Private Sub Insert_Tile()
		...
		ReDim tempTile(5120)
		Dim I_Am_The_Looping_Variable As Integer
		Dim Offset As Integer
		
		FileOpen(12, My.Application.Info.DirectoryPath & "\temp2.tmp", OpenMode.Binary, OpenAccess.Read)
		For I_Am_The_Looping_Variable = 1 To 5120
			'UPGRADE_WARNING: Get was upgraded to FileGet and has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			FileGet(12, tempTile(I_Am_The_Looping_Variable), I_Am_The_Looping_Variable)
		Next 
		FileClose(12)
		
		InsertTile = cboTileListSet.SelectedIndex
	...
	Private Sub cmdSaveTIS_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdSaveTIS.Click
		...
		Dim This_Variable_Is_Too_Long_Named_To_Accurately_Loop As Integer
		Dim HexTemp1 As Integer
		Dim HexTemp3, HexTemp2, HexTemp4 As String
		Dim PrintThis As Short
		
		FileOpen(15, cdgDialogOpen.FileName, OpenMode.Binary)
		...
		ElseIf Len(HexTemp2) = 3 Then 
			HexTemp3 = VB.Left(HexTemp2, 1)
			HexTemp4 = VB.Right(HexTemp2, 2)
			PrintThis = CDec("&H" & HexTemp4)
			'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			FilePut(15, PrintThis, 9)
			PrintThis = CDec("&H" & HexTemp3)
			'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			FilePut(15, PrintThis, 10)
			'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			FilePut(15, 0, 11)
			'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			FilePut(15, 0, 12)
		ElseIf Len(HexTemp2) = 4 Then 
			HexTemp3 = VB.Left(HexTemp2, 2)
			HexTemp4 = VB.Right(HexTemp2, 2)
			'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			FilePut(15, CDec("&H" & HexTemp4), 9)
			'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			FilePut(15, CDec("&H" & HexTemp3), 10)
			'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			FilePut(15, 0, 11)
			'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			FilePut(15, 0, 12)
		...
		If blnHeader = True Then
			For This_Variable_Is_Too_Long_Named_To_Accurately_Loop = 1 To TISsize
				'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
				FilePut(15, TIS(This_Variable_Is_Too_Long_Named_To_Accurately_Loop + 24), (This_Variable_Is_Too_Long_Named_To_Accurately_Loop + 24))
			Next 
		Else
			For This_Variable_Is_Too_Long_Named_To_Accurately_Loop = 1 To TISsize
				'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
				FilePut(15, TIS(This_Variable_Is_Too_Long_Named_To_Accurately_Loop), (This_Variable_Is_Too_Long_Named_To_Accurately_Loop + 24))
			Next 
		End If
	...
	Private Sub DumpTIS()
		Dim TISSizeTemp As Integer
		TISSizeTemp = TISsize
		TISsize = TISsize + 5120
		ReDim Dump(TISsize)
		Dim This_B_Another_Long_Arse_Looping_Variable As Integer
		Dim Loopity_Loopity_Loop As Integer
